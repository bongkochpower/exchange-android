...
class RegisterFragment : BaseFragment<FragmentRegisterBinding>(R.layout.fragment_register) {
    ...
    override fun subscribe() {
        ...
        registerViewModel.updateProfileResult().observe(viewLifecycleOwner) {
            when (it) {
            ...
            when (it) {
                ...
                is ResultWrapper.Success -> {
                    showAlertSuccessDialog {
                        Log.d("LOGD", "subscribe: goto main")
                    }
                }
                is ResultWrapper.GenericError -> {
                    AppAlert.alert(requireContext(), it.message).show(childFragmentManager)
    ...
    fun EdittextRegister.validateAfterTextChange() {
        this.addOnTextChangeListener(object : TextWatcher {
            ...
            override fun afterTextChanged(p0: Editable?) {
                ...
                this@validateAfterTextChange.setValidation(!isNotEmpty)
            }
        })
    }
        ...
        with(binding) {
            ...
            registerViewModel.register(
                RegisterRequestModel(
                    ...
                    idCardImagePath = registerViewModel.selectedIdCardImage,
                    postCode = "11111",
                    ...
                    provinceId = 1,
                    isConsent = chkRegTerm.isChecked
                )
            )
        }
    }
